...
public class DoublyLinkedList<E extends Comparable<E>> {
	...
	public String toString() { 
		...
		sb.append('[');
		this.head.buildString(sb);//Not sure how this works
		if (this.head.next != this.tail)//Not sure how this works
			sb.deleteCharAt(sb.length() - 1);//Not sure how this works
		sb.append(']');
		return sb.toString();
	}
}
