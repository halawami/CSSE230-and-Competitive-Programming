...
public class ShapeTest {
	...
	public void testSortTrianglesByAreaUsingTreeSet() {
		...
		// nice string method to do this? string.trim??
...
//		if(str.endsWith(" ")){
//			str.replace(str.substring(str.length()-7, str.length()), "");
//		}
...
//		 System.out.println(triangleSet); doesn't have the extra comma and space
